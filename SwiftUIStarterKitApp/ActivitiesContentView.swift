...
struct ShopPromotionBannerView: View {
    ...
    var body: some View {
        ...
        Button(action: {
            ...
            if self.selectedActivity.index == 1 {
                TealiumHelper.shared.track(
                    title: "product_detail_view",
                    data: [
                        "event_name": "teallium_remotecommand",
                        "test1": "remotecommand-test",
                        "customer_id": "kiyoshiamano",
                        "customer_first_name": "kiyoshi",
                        "customer_last_name": "amano",
                        "customer_email": "kiyoshi.amano+1226@tealium.com"
                    ]
                )
            }
                ...
                TealiumHelper.shared.track(
                    title: "purchase",
                    data: [
                        "user_identifier": "kiyotaroDX2",
                        "user_email": "kiyoshi.amano+1228@tealium.com",
                        "product_id": ["b101","b102"],
                        "product_quantity": [7, 11],
                        "product_price": [33.54, 79.20],
                        "order_currency": "USD"
                    ]
                )
            }
            else if self.selectedActivity.index == 0 {
                TealiumHelper.shared.track(
                    title: "home_view",
                    data: nil
                )
            ...
            print("Tap !! \(self.selectedActivity.index)");
